...
//define variable to access h1 element where ETH price is displayed
var priceEth = document.querySelector('h2')
...
function getETH(){
	...
	axios.get('https://min-api.cryptocompare.com/data/pricemulti?fsyms=ETH&tsyms=USD')
		.then(res => {
			...
			priceEth.innerHTML = '$' + cryptosETH.toLocaleString('en')
